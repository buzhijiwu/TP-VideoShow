	...
	showGuest:function(){
            ...
            if(!objC){
                if($("#myVideoBox").length<=0){
                    ...
                    var s=Dom.$C("script");
                    s.text="swfobject.embedSWF(\"/Public/Public/Swf/5ShowShowLivePlayer.swf?roomId="+_show.goodNum+"&rtmpHost="+_show.chat+"&cdn="+_show.cdnl+"&keyframe="+_show.zjg+"&height="+_show.height+"&width="+_show.width+"&fps="+_show.fps+"&bandwidth="+_show.zddk+"&quality="+_show.pz+"&language="+curLang+"&rtmpPort=1935&appName=5showcam\", \"JoyShowLivePlayer\", 428,316,\"10.0\", \"\", {},{wmode:\"transparent\",allowscriptaccess:\"always\"});guestflashSwf();JsInterface.guestdrag(\"myVideoBox\",\"dragguest\");";
		...
		try{
				if(data){
					...
					if(data["action"]==0){ //公聊
						...
						var toAllSay = data["equipment"]==undefined?'<p><span>'+time+'</span>'+icon+'<a class=\"chatuser\" gn="'+ugood+'" id='+uid+' href="javascript:void(0);">'+uname+'</a>'+cugood+': '+tempMsg+'</p>':'<p><span>'+time+'</span>'+icon+'<a class=\"chatuser\" gn="'+ugood+'" id='+uid+' href="javascript:void(0);"><img src="/Public/images/mobile.png"/>'+uname+'</a>'+cugood+': '+tempMsg+'</p>';
...
var giftstr='<p>土豪 <span style="color:#FF4040" scroll="#FF4040">'+uname+'</span> 驾驶着<span style="color:#FF4040" scroll="#FF4040">自行车</span>入场</p><p><em style=" background:url(/Public/first_pay/gift_9165.png) no-repeat; float:left;height:100px; width:160px;"></em></p><br /><br /><br /><br /><br />';
document.getElementById("test1").innerHTML=test1;
...
var giftstr='<p>土豪 <span style="color:#FF4040" scroll="#FF4040">'+uname+'</span> 驾驶着<span style="color:#FF4040" scroll="#FF4040">UFO</span>入场</p><p><em style=" background:url(/Public/first_pay/gift_9174.png) no-repeat; float:left;height:69px; width:150px;"></em></p><br /><br /><br /><br /><br />';
document.getElementById("test1").innerHTML=test1;
}else if(giftName==4)
{
...
var giftstr='<p>土豪 <span style="color:#FF4040" scroll="#FF4040">'+uname+'</span> 驾驶着<span style="color:#FF4040" scroll="#FF4040">悍马</span>入场</p><p><em style=" background:url(/Public/first_pay/gift_9176.png) no-repeat; float:left;height:95px; width:150px;"></em></p><br /><br /><br /><br /><br />';
document.getElementById("test1").innerHTML=test1;
}else if(giftName==3)
{
...
var giftstr='<p>土豪 <span style="color:#FF4040" scroll="#FF4040">'+uname+'</span> 驾驶着<span style="color:#FF4040" scroll="#FF4040">考维特</span>入场</p><p><em style=" background:url(/Public/first_pay/gift_9178.png) no-repeat; float:left;height:78px; width:146px;"></em></p><br /><br /><br /><br /><br />';
document.getElementById("test1").innerHTML=test1;
}else if(giftName==2)
{
...
var giftstr='<p>土豪 <span style="color:#FF4040" scroll="#FF4040">'+uname+'</span> 驾驶着<span style="color:#FF4040" scroll="#FF4040">法拉利</span>入场</p><p><em style=" background:url(/Public/first_pay/gift_9177.png) no-repeat; float:left;height:73px; width:150px;"></em></p><br /><br /><br /><br /><br />';
document.getElementById("test1").innerHTML=test1;
}else if(giftName==1)
{
...
var giftstr='<p>土豪 <span style="color:#FF4040" scroll="#FF4040">'+uname+'</span> 驾驶着<span style="color:#FF4040" scroll="#FF4040">布加迪威航</span>入场</p><p><em style=" background:url(/Public/first_pay/gift_9172.png) no-repeat; float:left;height:85px; width:150px;"></em></p><br /><br /><br /><br /><br />';
document.getElementById("test1").innerHTML=test1;
}
...
function loadpet(){	//加载宠物
	...
	var url="/showPet.do?";
	$(".lpet").append("<scr"+"ipt>swfobject.embedSWF(\"/Public/Public/Swf/JoyPet.swf\",\"JoyPet_left\", 230,300,\"10.0\", \"\",{pos:\"left\",url:\""+url+"\",uid:\""+uid+"\",zid:\""+zid+"\"},{quality:\"high\",wmode:\"transparent\",allowscriptaccess:\"always\"});</scr"+"ipt>");
	$(".rpet").append("<scr"+"ipt>swfobject.embedSWF(\"/Public/Public/Swf/JoyPet.swf\",\"JoyPet_right\", 230,300,\"10.0\", \"\",{pos:\"right\",url:\""+url+"\",uid:\""+uid+"\",zid:\""+zid+"\"},{quality:\"high\",wmode:\"transparent\",allowscriptaccess:\"always\"});</scr"+"ipt>");
}
...
var InitCache=function(){
	...
	alert("InitCache");
	$.getJSON("/Liveroom/showdata/emceeuserid/"+_show.emceeId+"/roomno/"+_show.roomId,function(json){
		alert(json);
		if(json && json.code==0){
			...
			function loadFlash(){
				...
				alert(_show.emceeId + "|" + _show.userId);
				if(_show.emceeId==_show.userId){
					_script.text="swfobject.embedSWF(\"/Public/Public/Swf/5ShowCamLivePlayer.swf?roomId="+_show.goodNum+"&rtmpHost="+_show.chat+"&cdn="+_show.cdn+"&keyframe="+_show.zjg+"&fps="+_show.fps+"&bandwidth="+_show.zddk+"&width="+_show.width+"&height="+_show.height+"&quality="+_show.pz+"&language="+curLang+"&rtmpPort=1935&appName=5showcam\",\"JoyCamLivePlayer\",480,360,\"10.0\", \"\",{},{quality:\"high\",wmode:\"opaque\",allowscriptaccess:\"always\"});"   
				}else{
					_script.text="swfobject.embedSWF(\"/Public/Public/Swf/5ShowShowLivePlayer.swf?roomId="+_show.goodNum+"&rtmpHost="+_show.chat+"&cdn="+_show.cdnl+"&keyframe="+_show.zjg+"&fps="+_show.fps+"&bandwidth="+_show.zddk+"&width="+_show.width+"&height="+_show.height+"&quality="+_show.pz+"&language="+curLang+"&rtmpPort=1935&appName=5showcam\",\"JoyShowLivePlayer\", 480,360,\"10.0\", \"\",{},{quality:\"high\",wmode:\"opaque\",allowscriptaccess:\"always\"});"     
				}
			...
			function operate(){
				...
				if(_show.emceeId==_show.userId){
					//<li><a href=\"javascript:WishGiftCtrl.makeWish();\" class=\"m-dream\" title=\"许愿\">许愿</a></li>
				   $('.tab-info ul').append("<li class=\"end\"><a href=\"javascript:Song.userVodSong();\" class=\"m-song\" title=\"点歌本\">点歌本</a></li>");
				}
