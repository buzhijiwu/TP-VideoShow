...
$(function(){
	...
	$('#show_num_btn').click(function(){
		...
		$('#gift-givenum').css({"left":(Gift_numobj.left)+"px","top":((Gift_numobj.top)-160)+"px"});
	...
	$('.gift-v li').mouseover(function(e){
		...
		var gid=$(this).find('img').attr('gid');
		//alert(gid + "=" + "#showgift"+gid);
		//alert((obj_gift.left) + "=" + ((obj_gift.top)));
		//$('#h_dou').css({"left":(obj_gift.left)+"px","top":((obj_gift.top-500))+"px"}).show();
		//$(this).find('div').css({"left":(obj_gift.left)+"px","top":((obj_gift.top-30px))+"px"}).show();
		$(this).find('#noneshow_box').css({"left":(obj_gift.left)+"px","top":((obj_gift.top-30))+"px"}).show();
		
		//$('#showgift'+gid).css({"left":(obj_gift.left)+"px","top":((obj_gift.top-500))+"px"}).show();
		//$('#showgift'+gid).css({"padding":(obj_gift.left)+"px " + ((obj_gift.top))+"px"}).show();
