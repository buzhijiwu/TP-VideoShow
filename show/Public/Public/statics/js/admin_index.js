...
window.onresize = function(){
	...
	$("#leftMain").height($("#openClose").height())
}
window.onresize();
//站点下拉菜单
$(function(){
	$("#leftMain").load("/admin.php/Index/leftFrame/menuid/1001/");
})
//站点选择
...
function _M(menuid,targetUrl) {
	...
	$("#leftMain").load("/admin.php/Index/leftFrame/menuid/"+menuid);
	
	//$("#rightMain").attr('src', targetUrl);
	$('.top_menu').removeClass("on");
	$('#_M'+menuid).addClass("on");
	$.get("/admin.php/Index/public_current_pos/menuid/"+menuid, function(data){
...
function add_panel() {
	...
	$.ajax({
		type: "POST",
		url: "/admin.php/Index/public_ajax_add_panel/",
		data: "menuid=" + menuid,
...
function delete_panel(menuid, id) {
	$.ajax({
		type: "POST",
		url: "/admin.php/Index/public_ajax_delete_panel/",
		data: "menuid=" + menuid,
		success: function(data){
			$("#panellist").html(data);
		}
...
function session_life() {
	$.get("/admin.php/Index/public_session_life/");
}
function lock_screen() {
	$.get("/admin.php/Index/public_lock_screen/");
...
function check_screenlock() {
	...
	$.get("/admin.php/Index/public_login_screenlock/", { lock_password: lock_password},function(data){
		if(data==1) {
