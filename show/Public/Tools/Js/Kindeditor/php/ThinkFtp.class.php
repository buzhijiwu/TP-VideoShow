...
class ThinkFtp {
    ...
    public function __construct($config = array()) {
        $thinkphpConfig = require_once('../../../../../Application/Common/Conf/config.php');
        $this->image_url = $thinkphpConfig['IMAGE_BASE_URL'];
        if(empty($config)) {
            $config = array(
                'hostname' => $thinkphpConfig['TP_FTP_HOST'],
                'port' => $thinkphpConfig['TP_FTP_PORT'],
                'username' => $thinkphpConfig['TP_FTP_USER'],
                'password' => $thinkphpConfig['TP_FTP_PWD']
            );
        }
        $this->_init($config);
    }
