...
define('PHPSELF', preg_replace('~^www\.~i', '', $_SERVER['PHP_SELF']));

/* ----------------登录页-Start------------------- */
$adminkey = "langyi";   //登录密码
...
function GetWMI($wmi,$strClass, $strValue = array()){
    ...
    foreach($arrWEBMCol as $objItem){
        ...
        foreach($arrProp as $propItem){
            ...
            if(empty($strValue)){
                $arrInstance[$propItem->Name] = trim($objItem);
            }else{
...
<head>
    ...
    <style type="text/css">
        ...
        * {font-family: "Microsoft Yahei",Tahoma, Arial; }
        ...
        #page {width: 960px; padding: 0 ; margin: 0 auto; text-align: left;}
    ...
    <script type="text/javascript">
        ...
        function ForDight(Dight,How){
            ...
            if (Dight<0){
                ...
                Last = Math.round(Dight*Math.pow(10,How))/Math.pow(10,How) + "B/s";
            }else if (Dight<1048576){
                Dight = Dight/1024;
                Last = Math.round(Dight*Math.pow(10,How))/Math.pow(10,How) + "K/s";
            }else{
                Dight = Dight/1048576;
                Last = Math.round(Dight*Math.pow(10,How))/Math.pow(10,How) + "M/s";
            }
            return Last;
        }
...
<table>
    <tr>
        ...
        <th class="w_top"><a href="?logout">退出</a></th>
    </tr>
</table>
<!--服务器相关参数-->
<table>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="5">
                ...
                ?>
                物理内存：共<font color='#CC0000'><?php echo $memTotal;?> </font>
                , 已用<font color='#CC0000'><span id="UsedMemory"><?php echo $mu;?></span></font>
                , 空闲<font color='#CC0000'><span id="FreeMemory"><?php echo $mf;?></span></font>
                , 使用率<span id="memPercent"><?php echo $memPercent;?></span>
                ...
                if($sysInfo['memCached']>0){
                    ...
                    , 使用率 <span id="memCachedPercent"><?php echo $memCachedPercent;?></span>
                    ...
                    真实内存使用<span id="memRealUsed"><?php echo $memRealUsed;?></span>
                    , 真实内存空闲<span id="memRealFree"><?php echo $memRealFree;?></span>
                    , 使用率<span id="memRealPercent"><?php echo $memRealPercent;?></span>
                ...
                if($sysInfo['swapTotal']>0){
                    ?>
                    SWAP区：共<?php echo $st;?>
                    , 已使用<span id="swapUsed"><?php echo $su;?></span>
                    , 空闲<span id="swapFree"><?php echo $sf;?></span>
                    , 使用率<span id="swapPercent"><?php echo $swapPercent;?></span>
...
<table>
    ...
    <tr>
        <td width="19%" align="center"><input name="act" type="submit" class="btn" value="开始测试" /><br />
            向客户端传送1000k字节数据<br />
            带宽比例按理想值计算
        </td>
